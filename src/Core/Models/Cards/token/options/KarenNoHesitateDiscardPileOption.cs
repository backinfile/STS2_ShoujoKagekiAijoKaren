...
{
    internal class KarenNoHesitateDiscardPileOption : KarenBaseCardModel
    {
        public KarenNoHesitateDiscardPileOption() : base(-1, CardType.Skill, CardRarity.Token, TargetType.None)
        {
        }
